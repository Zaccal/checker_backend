...
describe("GET Method - Subtasks", () => {
  describe("GET /search - Search subtasks", () => {
    test("GET search subtasks with valid query", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test subtask",
        {
          method: "GET",
    ...
    test("GET search subtasks with pagination", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test&offset=0&limit=5",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET search subtasks with invalid query format", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?invalid=param",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
  ...
  describe("GET /:id - Get subtasks by todoId or specific subtask", () => {
    test("GET subtasks by valid todoId", async () => {
      ...
      const response = await app.request(
        "/api/v1/subtasks/cmda1n4ft0000puolhjo0o7s5",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET specific subtask by valid subtaskId", async () => {
      ...
      const response = await app.request(
        "/api/v1/subtasks/cmda1oqdd0001puoltds2nuef",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET subtasks by non-existent todoId", async () => {
      const response = await app.request(
        "/api/v1/subtasks/nonexistent-todo-id",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET subtasks by non-existent subtaskId", async () => {
      const response = await app.request(
        "/api/v1/subtasks/nonexistent-subtask-id",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
  ...
  describe("Edge cases and error handling", () => {
    ...
    test("GET search with special characters in query", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test!@#$%",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET search with very long query", async () => {
      ...
      const response = await app.request(
        `/api/v1/subtasks/search?query=${longQuery}`,
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET search with negative offset", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test&offset=-5&limit=10",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET search with zero limit", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test&offset=0&limit=0",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
    ...
    test("GET search with very large limit", async () => {
      const response = await app.request(
        "/api/v1/subtasks/search?query=test&offset=0&limit=10000",
        {
          method: "GET",
          headers: globalThis.authHeader,
          credentials: "include",
