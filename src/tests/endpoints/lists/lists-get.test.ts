...
describe("GET Method", () => {
  ...
  test("GET by id", async () => {
    const response = await app.request(
      "/api/v1/lists/cmb3mgkmw00043p0u6ajrjjxm",
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
...
describe("GET /api/v1/lists/:listId/todos (filter endpoint)", () => {
  test("Filter by completed", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?completed=true`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Filter by expired", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?onlyExpired=true`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Filter by withDeadline", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?withDeadline=true`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Filter by withDeadline and onlyExpired", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?withDeadline=true&onlyExpired=true`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Filter by tagIds", async () => {
    ...
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?tagIds=${tagId}`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Filter by created date range", async () => {
    ...
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?createdFrom=${from}&createdTo=${to}`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Sort by title desc", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=title&sortOrder=desc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
    ...
    if (data.length > 1) {
      for (let i = 1; i < data.length; i++) {
        expect(
          data[i - 1].title.localeCompare(data[i].title)
  ...
  test("Sort by title asc", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=title&sortOrder=asc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Sort by createAt/updatedAt desc", async () => {
    const responseCreated = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=createdAt&sortOrder=desc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
    ...
    const responseUpadeted = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=updatedAt&sortOrder=desc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("Sort by createAt/updatedAt asc", async () => {
    const responseCreated = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=createdAt&sortOrder=asc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
    ...
    const responseUpadeted = await app.request(
      `/api/v1/lists/${listId}/todos?sortBy=updatedAt&sortOrder=asc`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
  ...
  test("No results for impossible filter", async () => {
    const response = await app.request(
      `/api/v1/lists/${listId}/todos?completed=true&completed=false`,
      {
        method: "GET",
        headers: globalThis.authHeader,
        credentials: "include",
